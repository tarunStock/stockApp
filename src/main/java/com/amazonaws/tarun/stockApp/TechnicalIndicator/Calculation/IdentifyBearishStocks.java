...
public class IdentifyBearishStocks {
	static Logger logger = Logger.getLogger(IdentifyBearishStocks.class);
	
	public static void main(String[] args) {
		Date dte = new Date();
		System.out.println("Start at -> " + dte.toString());
		IdentifyBearishStocks obj = new IdentifyBearishStocks();
